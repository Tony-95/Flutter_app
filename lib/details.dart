...
import 'package:yuka/flutter_bloc.dart';
...
class _ProductContentBodyFirstLine extends StatelessWidget {
  ...
  String? get _nutriScoreImage {
    switch (product.nutriScore?.toLowerCase()) {
      case 'a':
        return Images.nutriscoreA;
      case 'b':
        return Images.nutriscoreB;
      case 'c':
        return Images.nutriscoreC;
      case 'd':
        return Images.nutriscoreD;
      case 'e':
        return Images.nutriscoreE;
      default:
        return null;
    }
  }
